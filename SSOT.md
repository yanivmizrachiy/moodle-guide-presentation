...
12. **אסור מלל דמו או תיאור־עצמי.** אין בשקפים טקסט שיווקי, טקסט שמתאר את המצגת על עצמה, או מלל שנוצר על ידי AI ולא הוכתב במפורש. מלל כזה שמתגלה — מוסר לפי הוראת הבעלים, ואינו מוחלף בניסוח חדש ללא הכתבה שלו. שדה טקסט ריק עדיף על טקסט מומצא.
