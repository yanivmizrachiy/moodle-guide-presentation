...
13. **תקן איכות צילומים.** צילום חדש נקלט ברזולוציית המכשיר המלאה (ב־Playwright: `scale: 'device'`; לעולם לא ברירת המחדל שמקטינה פי 2). המקור (jpg/png) נשמר כפי שצולם ואינו נערך מחדש; נגזרות avif/webp נוצרות אך ורק דרך `scripts/derive-screenshots.mjs` (הקטנה ל־1920px עם Lanczos, חידוד עדין, AVIF q72 / WebP q90).
