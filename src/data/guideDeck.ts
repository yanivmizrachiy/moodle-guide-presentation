...
const AUTHORED_GUIDE_SLIDES: GuideSlide[] = [
  ...
  title: 'איך משנים את השם של מרחב הלימוד?',
  ...
  section: 'spaces',
  eyebrow: 'עריכת פרטי המרחב',
  title: 'איך משנים את התמונה הראשית של מרחב הלימוד?',
  ...
  section: 'spaces',
  eyebrow: 'עריכה',
  title: 'איך נכנסים למצב עריכה ומה אפשר לעשות בו?',
  ...
  screenshots: [{ src: '42-activity-menu.png', caption: 'תפריט ⋮ של פעילות במצב עריכה — „מחיקה” בתחתית התפריט.' }],
