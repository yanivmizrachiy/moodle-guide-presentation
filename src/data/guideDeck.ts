...
export type GuideSlide = {
  ...
  points?: string[];
  /**
   * Cards that open another slide of the guide. An index slide („מהם הכפתורים
   * הראשיים במרחב הלמידה?") lists the real buttons and each card takes the
   * teacher to the chapter that teaches that button — the list is navigation,
   * not prose (REQ-GUIDE-011).
   */
  indexCards?: readonly { label: string; slideId: string }[];
  tip?: string;
  warning?: string;
  screenshots?: GuideScreenshot[];
  link?: GuideLink;
...
const AUTHORED_GUIDE_SLIDES: AuthoredGuideSlide[] = [
  ...
  flow: [
    ...
    {
      text: 'לוחצים על הכפתור „אישור”.',
      screenshot: { src: '24-wizard-step4.png', caption: 'שלב „אישור וסיום” עם כפתור „אישור”.', hotspotIds: ['confirm-button'] },
    },
    {
      text: 'מופיעה ההודעה „בקשתך לפתיחת מרחב הלמידה התקבלה בהצלחה!”.',
      screenshot: { src: '39-wizard-background-create.png', caption: 'ההודעה שמתקבלת לאחר שליחת בקשת יצירת המרחב.' },
    },
    ...
    paths: [
      ...
      },
      {
        ...
        flow: [
          ...
          {
            text: 'המורה לוחץ על הכפתור „העתקת כתובת מרחב הלמידה ללוח”.',
            screenshot: {
  ...
  flow: [
    ...
    {
      text: 'נפתחת ההתראה „המערכת הצליחה ליצור את המרחב הלמידה שלך…”.',
      screenshot: {
        src: '40-wizard-notification-update.png',
        caption: 'פעמון ההתראות במודל עם ההתראה „המערכת הצליחה ליצור את המרחב הלמידה שלך…”.',
    ...
    {
      text: 'נפתחת רשימת המרחבים שפתחנו השנה והקיימים.',
      screenshot: {
  ...
  indexCards: [
    ...
    { label: 'ציונים', slideId: 'gradebook' },
    { label: 'דוחות', slideId: 'report-chooser' },
    { label: 'הגדרות', slideId: 'rename-space' },
  ],
  ...
  flow: [
    {
      text: 'לוחצים על הכפתור „מרחבי הלמידה שלי” בסרגל העליון.',
      screenshot: {
    ...
    },
    {
      ...
      screenshot: {
        ...
        caption: 'עמוד „מרחבי הלמידה שלי” בתצוגת תלמיד — המרחבים שהתלמיד רשום אליהם.',
      },
    },
  ],
  ...
  screenshots: [
    ...
    { src: '58-student-space-topic.png', caption: 'יחידת „יחס” בתצוגת תלמיד — בוחן „ממתין לביצוע” וסימוני ההשלמה בסרגל הצד.', hotspotIds: ['pending'] },
  ],
  ...
  warning: 'המורה אינו יכול לעקוב אחר הפעילות של תלמידים שעובדים במרחב הלימוד העצמי — הביצועים שם אינם מגיעים למרחב של המורה ואינם מופיעים בדוחות שלו.',
  ...
  flow: [
    {
      text: 'לוחצים על הכפתור „משתתפים” בתפריט המרחב.',
  ...
  flow: [
    ...
    {
      text: 'התלמיד לוחץ על הכפתור „רשום אותי” במסך ההצטרפות.',
      screenshot: { src: '53-student-enrol.png', caption: 'מסך התלמיד עם הכפתור „רשום אותי”.', hotspotIds: ['enrol-me'] },
    },
    {
      text: 'לתלמיד מופיעה ההודעה „נרשמתם לקורס בהצלחה”.',
  ...
  flow: [
    {
      text: 'התלמיד לוחץ על הכפתור „רשום אותי” במסך שבו צריך להירשם למרחב.',
    ...
    {
      text: 'התלמיד לוחץ על הכפתור „התחלת ניסיון מענה”.',
  ...
  flow: [
    {
      text: 'לוחצים על הכפתור „משתתפים”.',
      screenshot: { src: '10-course-page.png', caption: 'תפריט המרחב — לשונית „משתתפים”.', hotspotIds: ['participants-tab'] },
    },
    {
      text: 'נפתחת רשימת המשתתפים — כל מי שהצטרף למרחב. לכל משתתף יש סיווג: תלמיד או מורה, וכן ההרשמה, הקבוצה והגישה האחרונה.',
      screenshot: {
  ...
  // Changing a participant's role is taught once, where it belongs: „איך
  // מצרפים מורה נוסף למרחב הלימוד?". This slide only answers who is in the space.
  ...
  flow: [
    ...
    {
      text: 'בחלון האישור לוחצים על הכפתור „ביטול שיוך לתפקיד בקורס”.',
    ...
    { text: 'המשתתף נעלם מרשימת המשתתפים.' },
  ],
  ...
  flow: [
    {
      ...
      screenshot: {
        src: '90-course-tabs.png',
        caption: 'תפריט המרחב: „מרחב־לימוד”, „הגדרות”, „משתתפים”, „ציונים”, „דוחות”.',
        hotspotIds: ['participants-tab'],
      },
    },
    {
      text: 'פותחים את התפריט „משתמשים רשומים”.',
    ...
    {
      text: 'לוחצים על הכפתור „יצירת קבוצה”.',
      screenshot: {
    ...
    {
      text: 'בתחתית הטופס לוחצים על הכפתור „שמירת שינויים”.',
      screenshot: {
    ...
    {
      text: 'התלמיד שנוסף מופיע ברשימה „חברי הקבוצה”.',
      screenshot: {
        src: '73-group-add-members.png',
        caption: 'מסך הוספת המשתתפים — בוחרים תלמיד ולוחצים „הוספה”.',
    ...
    {
      text: 'נפתחת רשימת הקבוצות עם מספר החברים בכל קבוצה.',
  ...
  flow: [
    {
      text: 'לוחצים על הכפתור „ציונים” בתפריט המרחב.',
      screenshot: {
        src: '90-course-tabs.png',
        caption: 'תפריט המרחב: „מרחב־לימוד”, „הגדרות”, „משתתפים”, „ציונים”, „דוחות”.',
    ...
    },
    {
      ...
      screenshot: {
        ...
        caption: 'דוח הציונים — שורה לכל תלמיד ועמודה לכל פריט ציון, עם חיפוש ובחירת קבוצות.',
        hotspotIds: ['group-selector'],
      },
    },
    {
    ...
    {
      text: 'הדוח מציג רק את תלמידי הקבוצה שנבחרה.',
  ...
  flow: [
    ...
    {
      text: 'המורה הנוסף לוחץ על הכפתור „רשום אותי”.',
      screenshot: { src: '53-student-enrol.png', caption: 'מסך ההצטרפות עם הכפתור „רשום אותי”.', hotspotIds: ['enrol-me'] },
    },
    {
      text: 'לוחצים על הכפתור „משתתפים” בתפריט המרחב.',
    ...
    {
      text: 'נפתחת רשימת המשתתפים עם עמודת התפקידים.',
      screenshot: {
        src: '47-participants-list.png',
    ...
    {
      text: 'בשורת המשתתף לוחצים על סמל השמירה.',
      screenshot: { src: '48-role-edit-pencil.png', caption: 'עריכת התפקיד בשורה — בורר התפקיד עם שמירה וביטול.' },
    },
    {
  ...
  flow: [
    {
      text: 'לוחצים על הכפתור „הגדרות” בתפריט המרחב.',
    ...
    {
      text: 'בתחתית העמוד לוחצים על הכפתור „שמירת השינויים והצגתם”.',
      screenshot: {
  ...
  flow: [
    ...
    {
      text: 'לוחצים על הכפתור „הוספת משאב או פעילות”.',
      screenshot: {
    ...
    },
    {
      ...
      screenshot: { src: '16-activity-chooser.png', caption: 'בורר הפעילויות והמשאבים.', hotspotIds: ['type-card'] },
    },
    {
      text: 'מזינים את שם המשאב או הפעילות בטופס ההגדרות.',
      screenshot: {
        src: '100-activity-settings-name.png',
        caption: 'טופס ההגדרות של פעילות — שדה השם בראש „הגדרות כלליות”.',
        hotspotIds: ['activity-name'],
      },
    },
    {
      text: 'בתחתית העמוד לוחצים על הכפתור „שמירת שינויים וחזרה למרחב־לימוד”.',
      screenshot: {
  ...
  flow: [
    ...
    },
    {
      ...
      screenshot: { src: '42-activity-menu.png', caption: 'תפריט ⋮ של פעילות במצב עריכה — „זמינות” להסתרה.', hotspotIds: ['kebab'] },
    },
    {
    ...
    {
      text: 'על הפריט מופיע התג „מוסתר בפני תלמידים”.',
      screenshot: {
        src: '99-hidden-item.png',
  ...
  flow: [
    ...
    {
      text: 'פותחים את תפריט ⋮ של הפעילות.',
      screenshot: { src: '42-activity-menu.png', caption: 'תפריט ⋮ של פעילות במצב עריכה — „מחיקה” בתחתית התפריט.', hotspotIds: ['kebab'] },
    },
    {
      text: 'לוחצים על הכפתור „מחיקה”.',
      screenshot: { src: '42-activity-menu.png', caption: 'תפריט ⋮ של פעילות במצב עריכה — „מחיקה” בתחתית התפריט.', hotspotIds: ['delete'] },
    },
    {
      text: 'לוחצים על הכפתור „מחיקה” בחלון „האם למחוק את הפעילות?”.',
      screenshot: {
  ...
  screenshots: [
    { src: '58-student-space-topic.png', caption: 'הבוחן „יחס - בסיסי” עם האייקון הוורוד ביחידת ההוראה.', hotspotIds: ['activity-link'] },
  ],
  ...
  flow: [
    ...
    {
      text: 'המשימה מופיעה במיקומה החדש.',
      screenshot: {
  ...
  flow: [
    ...
    {
      text: 'לוחצים על שם המשתמש בסרגל העליון.',
      screenshot: {
    ...
    },
    {
      text: 'בוחרים „תלמיד”.',
      screenshot: {
        src: '104-switch-role-choice.png',
        caption: 'מסך „החלפת תפקיד ל...” — הכפתורים „תלמיד” ו„אורח”.',
        hotspotIds: ['student-role'],
      },
    },
    {
      text: 'המרחב נפתח בתצוגת תלמיד — בסרגל העליון מופיע התג „תלמיד”.',
      screenshot: {
        src: '105-student-view-space.png',
        caption: 'המרחב בתצוגת תלמיד — בסרגל העליון מופיע התפקיד הנוכחי „תלמיד”.',
        hotspotIds: ['role-indicator'],
    ...
    {
      text: 'לוחצים שוב על שם המשתמש בסרגל העליון.',
      screenshot: {
    ...
    {
      text: 'בוחרים „חזרה לתפקיד הרגיל שלי”.',
      screenshot: {
        src: '106-return-to-teacher-role.png',
        caption: 'תפריט המשתמש בתצוגת תלמיד — „חזרה לתפקיד הרגיל שלי”.',
  ...
  flow: [
    {
      text: 'לוחצים על הכפתור „אפשרויות נוספות” בתפריט המרחב.',
      screenshot: { src: '08-more-options.jpg', caption: 'תפריט „אפשרויות נוספות” כולל ניהול כלי LTI.', hotspotIds: ['more-tab'] },
    },
    {
  ...
  flow: [
    {
      text: 'לוחצים על הכפתור „אפשרויות נוספות” בתפריט המרחב.',
      screenshot: {
        src: '96-more-options-menu.png',
        caption: 'תפריט „אפשרויות נוספות” פתוח — „שימוש חוזר בתכנים” ברשימה.',
        hotspotIds: ['more-options-tab'],
      },
    },
    {
      text: 'בוחרים „שימוש חוזר בתכנים”.',
      screenshot: {
        src: '96-more-options-menu.png',
        caption: 'תפריט „אפשרויות נוספות” פתוח — „שימוש חוזר בתכנים” ברשימה.',
        hotspotIds: ['more-menu'],
      },
    },
    {
    ...
    },
    {
      ...
      screenshot: { src: '85-import-confirm.png', caption: '„אישור ותצוגה” — סקירת מה ייובא, לפני שלב „ביצוע יבוא”.' },
    },
    { text: 'מבצעים את שלב „ביצוע יבוא”.' },
    { text: 'מופיע שלב „הושלם”.' },
  ],
  ...
  flow: [
    ...
    },
    {
      ...
      screenshot: { src: '32-updates-list-expanded.jpg', caption: 'רשימת העדכונים וידית הגרירה.' },
    },
    { text: 'גוררים את העדכון ליחידת ההוראה המתאימה.' },
  ],
    ...
    paths: [
      {
        ...
        flow: [
          ...
          {
            text: 'נפתח עמוד המשימה עם „התחלת ניסיון מענה”.',
            screenshot: {
  ...
  flow: [
    ...
    {
      text: 'מזינים את התשובה בשאלה.',
      screenshot: { src: '64-quiz-question.png', caption: 'עמוד שאלה בבוחן — הזנת התשובה ו„העמוד הבא”.' },
    },
    {
      text: 'לוחצים על הכפתור „העמוד הבא”.',
      screenshot: { src: '64-quiz-question.png', caption: 'עמוד שאלה בבוחן — „העמוד הבא”.', hotspotIds: ['next-page'] },
    },
    {
      text: 'בסיום לוחצים על הכפתור „שמירה וסיום”.',
      screenshot: { src: '64-quiz-question.png', caption: 'עמוד שאלה בבוחן — „שמירה וסיום”.', hotspotIds: ['save-finish'] },
    },
    { text: 'לוחצים על הכפתור „הגשה סופית”.' },
    {
      text: 'נפתחת „סקירת ניסיון מענה” לאחר ההגשה הסופית.',
  ...
  flow: [
    ...
    },
    {
      ...
      screenshot: { src: '42-activity-menu.png', caption: 'תפריט ⋮ של פעילות במצב עריכה — „הגדרות” בראש התפריט.', hotspotIds: ['kebab'] },
    },
    {
      text: 'לוחצים על הכפתור „הגדרות”.',
      screenshot: {
    ...
    {
      text: 'קובעים את „מספר נסיונות מותרים”.',
    ...
    {
      text: 'קובעים את „מנגנון המשוב בשאלות”.',
      screenshot: {
    ...
    {
      text: 'בתצוגת התלמיד מופיע הכפתור „ניסיון חדש”.',
  ...
  flow: [
    ...
    {
      text: 'לוחצים על הכפתור „ציונים” בתפריט התלמיד.',
      screenshot: { src: '57-student-space-home.png', caption: 'תפריט התלמיד במרחב — „ציונים”.', hotspotIds: ['grades-tab'] },
    },
    {
      text: 'ב„דוח ציוני התלמיד במרחב־לימוד זה” מופיע הציון במשימה.',
      screenshot: {
        src: '60-student-grade-report.png',
        caption: '„דוח ציוני התלמיד במרחב־לימוד זה” — „ציונים” בתפריט התלמיד.',
        hotspotIds: ['task-grade-row'],
      },
    },
  ],
  ...
  flow: [
    ...
    { text: 'לוחצים על הבוחן במרחב־הלימוד.' },
    {
      text: 'בעמוד הבוחן מופיע „ציון עובר: 80.00 מתוך 100.00”.',
    ...
    {
      text: 'בתצוגת התלמיד מופיע מצבו מול ציון העובר: „בוצע” בירוק או „נכשל” באדום.',
      screenshot: { src: '56-quiz-retry.png', caption: 'תצוגת התלמיד: „ציון עובר: 80.00 מתוך 100.00” והתג „נכשל” באדום.', hotspotIds: ['result-badges'] },
    },
  ],
  ...
  flow: [
    ...
    {
      text: 'לוחצים על הכפתור „הצגת יומני מעקב אלו”.',
      screenshot: {
        src: '51-logs-chooser.png',
        caption: '„בחירת יומני מעקב אותם יש להציג” — המסננים והכפתור „הצגת יומני מעקב אלו”.',
    ...
    {
      text: 'בטבלה מופיעים מי ביצע, איזו פעולה ובאיזה תאריך ושעה.',
      screenshot: {
  ...
  flow: [
    ...
    {
      text: 'בעמודת „זמן” מופיעים לכל פעולה התאריך והשעה.',
      screenshot: {
        src: '52-logs-table.png',
  ...
  flow: [
    { text: 'לוחצים על הבוחן במרחב־הלימוד.' },
    {
      text: 'בעמוד הבוחן מופיע „ניסיונות מענה”.',
      screenshot: {
        src: '68-quiz-view-teacher.png',
    ...
    {
      text: 'לוחצים על הכפתור „תוצאות”.',
      screenshot: {
        src: '68-quiz-view-teacher.png',
        caption: 'עמוד הבוחן למורה — „ניסיונות מענה: 1”, שיטת מתן הציון וציון עובר.',
        hotspotIds: ['results-tab'],
      },
    },
    {
      text: 'בטבלה מופיעים לכל תלמיד הניסיונות, מועדי ההתחלה והסיום והציון של כל ניסיון.',
  ...
  screenshots: [
    ...
    { src: '67-quiz-attempts-report.png', caption: 'דוח התוצאות — „שיטת מתן הציונים עבור בוחן זה הוא הציון הגבוה ביותר”.', hotspotIds: ['highest-grade-note'] },
  ],
  ...
  flow: [
    ...
    },
    {
      ...
      screenshot: {
        src: '66-gradebook-export.png',
        caption: 'מסך היצוא — בחירת הפורמט וסימון פריטי הציון.',
        hotspotIds: ['export-items'],
      },
    },
    {
      text: 'לוחצים על הכפתור „הורדה”.',
      screenshot: {
        src: '66-gradebook-export.png',
        caption: 'מסך היצוא — בחירת הפורמט וסימון פריטי הציון.',
        hotspotIds: ['download'],
  ...
  points: ['פעולה ומועד — „יומני מעקב”.', 'השלמה — „דוח השלמות פעילות”.', 'צפיות — „פעילות מרחב־לימוד”.', 'ציונים — יומן הציונים של המרחב.'],
  ...
  flow: [
    {
      text: 'מוודאים שהתלמיד נמצא במרחב הנכון ולא ב„למידה עצמית”.',
      screenshot: {
        src: '30-student-mycourses-selflearning.jpg',
    ...
    {
      text: 'בודקים שהפריט אינו נושא את התג „מוסתר בפני תלמידים”.',
      screenshot: {
        src: '99-hidden-item.png',
        caption:
          'תגית „מוסתר בפני תלמידים” על פריט במרחב, לצד תגית „זמין לסטודנטים, אך אינו מוצג בעמוד הראשי של הקורס”.',
    ...
    {
      text: 'בהגדרות הפעילות בודקים את „זמינות”.',
      screenshot: {
        src: '101-activity-settings-access.png',
        caption: 'בהגדרות הפעילות: השדה „זמינות” ואזור „הגבלת גישה” עם „הוספת הגבלה”.',
        hotspotIds: ['availability-select'],
    ...
    {
      text: 'באזור „הגבלת גישה” בודקים אם קיימת הגבלה.',
      screenshot: {
        src: '101-activity-settings-access.png',
        caption: 'בהגדרות הפעילות: השדה „זמינות” ואזור „הגבלת גישה” עם „הוספת הגבלה”.',
        hotspotIds: ['add-restriction'],
      },
    },
    {
      text: 'בודקים את תאריכי הפעילות.',
      screenshot: {
        src: '86-quiz-settings-grades.png',
        caption: 'אזור „תזמון” בהגדרות הבוחן — „תחילת הבוחן” ו„סיום הבוחן”.',
        hotspotIds: ['timing'],
    ...
    { text: 'בודקים את שיוך התלמיד לקבוצה.' },
    {
